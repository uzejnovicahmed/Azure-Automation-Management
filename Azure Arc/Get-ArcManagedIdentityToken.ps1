...
Get-Token -ResourceURL "https://management.azure.com"
#Get-Token -ResourceURL "https://graph.microsoft.com"
#Get-Token -ResourceURL "api://AzureADTokenExchange" -> Federated token App Registration 
